namespace piesCustomExport
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dashboardDesigner1.DashboardItemControlUpdated += new DevExpress.DashboardWin.DashboardItemControlUpdatedEventHandler(this.dashboardDesigner1_DashboardItemControlUpdated);
            this.dashboardDesigner1.CustomExport += new DevExpress.DashboardCommon.CustomExportEventHandler(this.dashboardDesigner1_CustomExport);
            // 
            // Form1
            // 
